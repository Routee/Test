...
public class BitmapUtil {
    ...
    public static Uri getRotatedUri(Activity activity, String path) {
        int degree = com.lzy.imagepicker.util.BitmapUtil.getBitmapDegree(path);
        if (degree != 0) {
            Bitmap bitmap = BitmapFactory.decodeFile(path);
            Bitmap newBitmap = com.lzy.imagepicker.util.BitmapUtil.rotateBitmapByDegree(bitmap, degree);
